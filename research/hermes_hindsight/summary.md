...
- **Hot:** memory/long_term.md + user/vijay.md (frozen, ~3.5KB)
...
- **research/hermes_hindsight/implementation_guide.md** - Step-by-step deployment (4 phases)
- **research/hermes_hindsight/technical_reference.md** - Architecture, APIs, performance tuning
- **research/hermes_hindsight/summary.md** - This document (executive overview)
