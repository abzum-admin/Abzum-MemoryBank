---
id: res-hermes-analysis
title: Hermes + Hindsight BI Memory Analysis
summary: Full 30KB analysis of Hermes + Hindsight as a BI memory architecture for enterprises
tags: [research, hermes, hindsight, bi]
updated: 2026-05-09
load_priority: 25
load_lane: reference
status: active
...
1. **Built-in 10-memory/long_term.md** (~800 tokens): Durable facts, environment details, project conventions
2. **Built-in 12-private/vijay.md** (~500 tokens): User profile, preferences, communication style
...
**How Hermes Delivers:**
- **System Prompt Construction**: Hermes builds a context-aware system prompt from personality (02-org/01-executive/felix-caio/soul.md), current memory state, active skills, and tool guidance
- **Built-in Memory Injection**: 10-memory/long_term.md and 12-private/vijay.md are frozen snapshots injected at session start
...
**How Hermes Delivers:**
- **02-org/01-executive/felix-caio/soul.md File**: Personality, tone, role definition, and interaction style (frozen snapshot)
- **12-private/vijay.md Profile**: User-specific preferences, communication style, technical skill level
...
1. Personality (02-org/01-executive/felix-caio/soul.md) - "You are a BI analyst who..."
2. Memory (10-memory/long_term.md) - Task history and conventions
3. User Profile (12-private/vijay.md) - How to talk to this user
...
|---|---|---|---|
| Multi-tier memory (hot/warm/cold) | ✅ Native | FULL | 10-memory/long_term.md (hot), Hindsight (warm), Session search (cold) |
...
│          │  │            │  │                │
│10-memory/long_term.md │  │~40+ skills │  │Knowledge Graph │
│12-private/vijay.md   │  │(level 0/1) │  │Entity Extract. │
│02-org/01-executive/felix-caio/soul.md   │  │            │  │Multi-strategy  │
└──────────┘  └────────────┘  │  Search        │
                               │Temporal Model  │
                               │Cross-memory    │
                               │  Synthesis     │
