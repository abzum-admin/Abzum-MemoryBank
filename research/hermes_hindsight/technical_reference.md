...
│  │ • Personality (agent/soul.md)                                    │  │
│  │ • Memory Injection (memory/long_term.md, user/vijay.md frozen snapshots)  │  │
...
- Assembled at session start from:
  - memory/long_term.md (2,200 chars)
  - user/vijay.md (1,375 chars)
...
**Implementation:**
- agent/soul.md (Hermes personality document)
...
1. Personality/instructions (agent/soul.md)
2. Memory context (memory/long_term.md)
3. User profile (user/vijay.md)
4. Active skills
5. Tool definitions
...
|---|---|---|
| Built-in memory (memory/long_term.md + user/vijay.md) | ~3.5KB | Fixed |
