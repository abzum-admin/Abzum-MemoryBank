---
id: res-hermes-summary
title: Hermes + Hindsight Executive Summary
summary: Executive summary of the Hermes + Hindsight analysis
tags: [research, hermes, hindsight]
updated: 2026-05-09
load_priority: 30
load_lane: reference
status: active
...
- **Hot:** 10-memory/long_term.md + 12-private/vijay.md (frozen, ~3.5KB)
...
└──────┘ └──────┘ └──┬───────┘  │
            ...
            Built-in Storage:    │
            • SQLite (sessions)  │
            • 10-memory/long_term.md          │
            • 12-private/vijay.md            │
            • 02-org/01-executive/felix-caio/soul.md            │
            • ~/.hermes/skills/  │
```
...
- **07-research/hermes-hindsight/implementation_guide.md** - Step-by-step deployment (4 phases)
- **07-research/hermes-hindsight/technical_reference.md** - Architecture, APIs, performance tuning
- **07-research/hermes-hindsight/summary.md** - This document (executive overview)
