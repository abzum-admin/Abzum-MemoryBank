...
**For humans:** start at `now.md` for current state, then `11-work/registry.md` for the full work backlog.
...
| `02-org/01-executive/felix-caio/instructions.md` | Agent session-start ritual and rules |
| `11-work/registry.md` | All work IDs (A##/B##/P##/D##/UC-##/O##) |
| `11-work/actions.md` | Active actions only |
| `11-work/decisions.md` | Pending and decided decisions |
| `11-work/blockers.md` | Active blockers |
| `11-work/operations_log.md` | Audit log of significant actions (O##) |
| `10-memory/long_term.md` | Felix's curated long-term memory (main session only) |
...
Generated files (`_index.md`, `_manifest.json`, `11-work/registry.md`/`actions.md`/`decisions.md`/`blockers.md`) are rebuilt from frontmatter and `11-work/registry.json`:
