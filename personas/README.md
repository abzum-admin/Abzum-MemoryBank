...
**Tier mapping** is defined in [`strategy/two_tier_architecture.md`](../strategy/two_tier_architecture.md). The 11 Paperclip meta-agents (RBAC, Compliance, Provisioning, etc.) live in Tier 1 alongside Orchestrator/Watcher and are documented separately in [`strategy/agent_orchestration.md`](../strategy/agent_orchestration.md). Personas here represent the **active project team** assembled per project.
...
8. **Use Cases** — links to UC rows in `work/registry.json`
...
Full pattern documentation: [`execution/persona_hermes_config.md`](../execution/persona_hermes_config.md).

## Subscription Stacks

The Best Value ($40/mo) and Best Performance ($50/mo) stacks, the BA voice runtime architecture, and the master persona table live in [`strategy/persona_team_v013.md`](../strategy/persona_team_v013.md).

## Use-Case Mapping

Which personas join which Abzum project use cases is in [`execution/use_case_team_mapping.md`](../execution/use_case_team_mapping.md).
