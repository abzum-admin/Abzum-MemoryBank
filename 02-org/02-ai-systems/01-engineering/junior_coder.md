...
The Junior Coder is the canonical example of **Pattern B (CLI-as-Tool)** documented in [`05-process/persona_hermes_config.md`](../../../05-process/persona_hermes_config.md). On the BV stack, the Hermes profile runs on a cheap GLM-5.1 brain whose job is to:
