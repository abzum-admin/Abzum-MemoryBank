...
│  │ • Personality (SOUL.md)                                    │  │
│  │ • Memory Injection (MEMORY.md, USER.md frozen snapshots)  │  │
...
**Implementation:**
- SOUL.md (Hermes personality document)
...
1. Personality/instructions (SOUL.md)
...
|---|---|---|
| Built-in memory (MEMORY.md + USER.md) | ~3.5KB | Fixed |
