...
- **Caveat**: Grok has a **30-min hard session cap**. The BA runtime must implement session rollover (Pipecat session boundary + Recall.ai bot context handoff) for longer calls. Open implementation question — see `05-process/persona_hermes_config.md`.
...
## References
- [`08-strategy/persona_team_v013.md`](../../../08-strategy/persona_team_v013.md) — full BA voice comparison
