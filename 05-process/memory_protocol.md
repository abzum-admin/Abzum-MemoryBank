...
- `10-memory/long_term.md` — Felix COO long-term curation, reviewed at each heartbeat session
- `12-private/vijay.md` — Vijay (MD) preferences and working style
- `02-org/01-executive/felix-caio/identity.md` — Felix Stanley (COO) identity and role
- `02-org/01-executive/felix-caio/instructions.md` — Agent instructions for this workspace
- `02-org/01-executive/felix-caio/soul.md` — Core values and operating principles
...
| **Layer 5** | ClickHouse analytics + 10-memory/long_term.md | Performance trends + COO long-term institutional wisdom | Permanent |
...
│  Built-in files:                   10-memory/long_term.md ✅     │
│                                    12-private/vijay.md ✅       │
...
9. **Text > Brain.** "Memory is limited — if you want to remember something, WRITE IT TO A FILE." (via Hindsight.retain, LLM Wiki.ingest, or 10-memory/long_term.md). In-context knowledge evaporates at session end.
...
- `08-strategy/agent_orchestration.md` — End-to-end orchestration: 3-layer architecture, agent lifecycle, intake-to-delivery flow
- `05-process/workflow_superpowers.md` — Workflow gates, TDD cycle, role definitions, model routing
- `05-process/handoff.md` — Structured handoff formats between agents
