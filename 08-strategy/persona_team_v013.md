...
|---|---|---|---|---|
| 1 | Orchestration | [Orchestrator](../02-org/04-platform-orchestration/01-orchestration/orchestrator.md) | GLM-5.1 via OpenCode Go ($10/mo) | Gemini 3.1 Pro via Vertex pay-go |
| 2 | Orchestration | [Watcher](../02-org/04-platform-orchestration/01-orchestration/watcher.md) | Gemma 4 E4B (local, $0) | Phi-4-mini (local, $0) |
| 3 | Product | [Triage / Intake](../02-org/02-ai-systems/02-project-delivery/triage_intake.md) | GLM-5.1 via OpenCode Go | Claude Sonnet 4.6 via Claude Code |
| 4 | Product | [Business Analyst](../02-org/02-ai-systems/02-project-delivery/_legacy_business_analyst.md) | **Gemini 3.1 Flash Live** ($0.018/min) | **Grok `voice-think-fast-1.0`** ($0.05/min) |
| 5 | Product | [Planner](../02-org/02-ai-systems/02-project-delivery/planner.md) | Qwen 3.5 Plus (thinking) | GPT-5.5 via Codex CLI |
| 6 | Engineering | [Architect](../02-org/02-ai-systems/01-engineering/architect.md) | GLM-5.1 in Claude Code (Z.ai) | Claude Opus 4.7 via Claude Pro |
| 7 | Engineering | [Senior Coder](../02-org/02-ai-systems/01-engineering/senior_coder.md) | Grok 4.3 via OpenRouter | Claude Opus 4.7 via Claude Code |
| 8 | Engineering | [Junior Coder](../02-org/02-ai-systems/01-engineering/junior_coder.md) | GLM-5.1 / Kimi K2.5 via OpenCode Go | GPT-5.5 in Codex CLI |
| 9 | Engineering | [Tester](../02-org/02-ai-systems/01-engineering/tester.md) | Kimi K2.6 + Playwright MCP | Claude Sonnet 4.6 + Playwright MCP |
| 10 | Engineering | [Security](../02-org/02-ai-systems/01-engineering/security.md) | GLM-5.1 in Claude Code (Z.ai) | Claude Opus 4.7 via Claude Code |
| 11 | Engineering | [DevOps / Release Engineer](../02-org/02-ai-systems/01-engineering/devops.md) | GLM-5.1 via OpenCode Go | GPT-5.5 via Codex CLI |
| 12 | Engineering | [Infrastructure Engineer](../02-org/02-ai-systems/01-engineering/infrastructure_engineer.md) | GLM-5.1 via OpenCode Go | Claude Opus 4.7 via Claude Code |
| 13 | Design | [Interface Designer](../02-org/02-ai-systems/03-design/interface_designer.md) | GLM-5.1 (Claude Artifacts surface) | Claude Sonnet 4.6 + v0 API |
| 14 | Design | [Brand Designer](../02-org/02-ai-systems/03-design/brand_designer.md) | GLM-5.1 via OpenCode Go | Claude Sonnet 4.6 via Claude Code |
| 15 | Design | [Motion & Video Designer](../02-org/02-ai-systems/03-design/motion_designer.md) | GLM-5.1 + open-source pipeline | Gemini 3.1 Pro via Gemini CLI |
| 16 | Knowledge | [Researcher](../02-org/02-ai-systems/04-knowledge-intelligence/researcher.md) | Kimi K2.6 via Kimi CLI / OpenCode Go | Gemini 3.1 Pro via Gemini CLI |
| 17 | Knowledge | [Tech Writer](../02-org/02-ai-systems/04-knowledge-intelligence/tech_writer.md) | GLM-5.1 via OpenCode Go | Claude Sonnet 4.6 via Claude Code |
...
- **Open implementation question**: Grok's 30-min session cap requires session rollover for longer calls. Documented in [`02-org/02-ai-systems/02-project-delivery/_legacy_business_analyst.md`](../02-org/02-ai-systems/02-project-delivery/_legacy_business_analyst.md) and [`exec-persona-hermes-config`](../05-process/persona_hermes_config.md).
...
- [`08-strategy/agent_orchestration.md`](agent_orchestration.md) — 3-layer orchestration + 11 Paperclip meta-agents
- [`08-strategy/two_tier_architecture.md`](two_tier_architecture.md) — Tier 1 / Tier 2 separation
- [`05-process/persona_hermes_config.md`](../05-process/persona_hermes_config.md) — Pattern A vs Pattern B persona hosting; canonical Junior Coder + Codex CLI cowork example
- [`05-process/use_case_team_mapping.md`](../05-process/use_case_team_mapping.md) — UC → persona team mapping
