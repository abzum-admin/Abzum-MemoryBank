...
1. **Built-in memory/long_term.md** (~800 tokens): Durable facts, environment details, project conventions
2. **Built-in user/vijay.md** (~500 tokens): User profile, preferences, communication style
...
**How Hermes Delivers:**
- **System Prompt Construction**: Hermes builds a context-aware system prompt from personality (agent/soul.md), current memory state, active skills, and tool guidance
- **Built-in Memory Injection**: memory/long_term.md and user/vijay.md are frozen snapshots injected at session start
...
**How Hermes Delivers:**
- **agent/soul.md File**: Personality, tone, role definition, and interaction style (frozen snapshot)
- **user/vijay.md Profile**: User-specific preferences, communication style, technical skill level
...
1. Personality (agent/soul.md) - "You are a BI analyst who..."
2. Memory (memory/long_term.md) - Task history and conventions
3. User Profile (user/vijay.md) - How to talk to this user
...
|---|---|---|---|
| Multi-tier memory (hot/warm/cold) | ✅ Native | FULL | memory/long_term.md (hot), Hindsight (warm), Session search (cold) |
...
│          │  │            │  │                │
│memory/long_term.md │  │~40+ skills │  │Knowledge Graph │
│user/vijay.md   │  │(level 0/1) │  │Entity Extract. │
│agent/soul.md   │  │            │  │Multi-strategy  │
└──────────┘  └────────────┘  │  Search        │
                               │Temporal Model  │
                               │Cross-memory    │
                               │  Synthesis     │
