...
- `work/registry.md`, `work/actions.md`, `work/decisions.md`, `work/blockers.md` — regenerated from `work/registry.json` by `_tools/gen_work_views.py`.
...
All work IDs live in `work/registry.json` (machine-readable source of truth).
...
- **Within markdown:** use relative paths: `[Azure](operations/infrastructure/azure.md)`.
...
- `user/vijay.md` — Managing Director identity
- `company/team/vijay.md` — Same identity in team context
...
3. Pick a unique `id`.
4. If it tracks work, add the corresponding entry to `work/registry.json`.
