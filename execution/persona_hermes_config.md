...
This document defines the **two patterns** by which a persona is hosted in Hermes v0.13, and the `~/.hermes/config.yaml` shape for each. The master persona table and subscription stacks are in [`strat-persona-v013`](../strategy/persona_team_v013.md).
...
The Junior Coder persona (see [`personas/engineering/junior_coder.md`](../personas/engineering/junior_coder.md)) is the canonical Pattern B example. On the BV stack:
...
**Status**: TODO — flagged in `personas/product/business_analyst.md`. Implementation belongs to a separate A-series action when first BA deployment lands.
...
**Status**: TODO — relates to A54 (token usage tracking) in `work/registry.json`.

---

## References

- [`strategy/persona_team_v013.md`](../strategy/persona_team_v013.md) — master persona table + subscription stacks
- [`personas/engineering/junior_coder.md`](../personas/engineering/junior_coder.md) — Pattern B canonical example
- [`personas/product/business_analyst.md`](../personas/product/business_analyst.md) — separate-runtime example
- [`agent/tools.md`](../agent/tools.md) — local tool inventory (Whisper, Ollama, etc.)
