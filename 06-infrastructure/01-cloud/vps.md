...
- **Abzum Setup App** — `https://setup.abzum.cloud`; primary interface for module installs, health monitoring, uninstalls — see [setup_app.md](../04-procedures/setup_app.md)
