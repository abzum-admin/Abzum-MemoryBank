...
See `05-process/handoff.md` for full structured output formats per role and document flow.

See `05-process/memory_protocol.md` for the five memory layers and ByteRover usage.
